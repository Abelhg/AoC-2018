# Advent Of Code: Dia 13 - Segunda parte
		...
		for carro2 in CARROS:
			if carro != carro2:
				if carro[0] == carro2[0] and carro[1] == carro2[1]:
					# Elimina los carros que chocan
					aBorrar.append(carro)
					aBorrar.append(carro2)
					break

	for carro in aBorrar:
		CARROS.remove(carro)

print "Solucion:", (CARROS[0][0], CARROS[0][1])